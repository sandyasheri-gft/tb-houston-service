...
class Solution(db.Model):
    ...
    name = db.Column(db.String(255))
    description = db.Column(db.String(255))
    businessunit_id = db.Column(db.Integer(),foreign_key=True)
    cost_centre = db.Column(db.String(255))
    ci_id = db.Column(db.Integer(),foreign_key=True)
    cd_id = db.Column(db.Integer(),foreign_key=True)
    sourcecontrol_id = db.Column(db.Integer(),foreign_key=True)
    ...
    workspace_id = db.Column(db.Integer(),foreign_key=True)
